...
export const districtsByRegion: DistrictsByRegion = {
  ...
  "6": [ // Qashqadaryo
    ...
    { id: "81", name: "Kitob t" },
    { id: "82", name: "Koson t" },
    { id: "83", name: "Mirishkor t" },
    { id: "84", name: "Muborak t" },
    { id: "85", name: "Nishon t" },
  ...
  "8": [ // Namangan
    { id: "99", name: "Namangan" },
    { id: "100", name: "Kosonsoy" },
    { id: "101", name: "Mingbuloq" },
    { id: "102", name: "Norin" },
    { id: "103", name: "Pop" },
    { id: "104", name: "To'raqo'rg'on" },
    { id: "105", name: "Uchqo'rg'on" },
    { id: "106", name: "Uychi" },
    { id: "107", name: "Yangiqo'rg'on" },
    { id: "108", name: "Chortoq" },
    { id: "109", name: "Chust" },
    { id: "110", name: "Namangan sh" },
  ],
  "9": [ // Samarqand
  ...
  "10": [ // Sirdaryo
    { id: "125", name: "Sirdaryo" },
    { id: "126", name: "Boyovut" },
    { id: "127", name: "Guliston" },
    { id: "128", name: "Oqoltin" },
    { id: "129", name: "Sayxunobod" },
    { id: "130", name: "Sardoba" },
    { id: "131", name: "Sirdaryo sh" },
    { id: "132", name: "Xavos" },
    { id: "133", name: "Mirzaobod" },
  ],
  "11": [ // Surxondaryo
    { id: "134", name: "Surxondaryo" },
    { id: "135", name: "Angor" },
    { id: "136", name: "Bandixon" },
    { id: "137", name: "Boysun" },
    { id: "138", name: "Denov" },
    { id: "139", name: "Jarqo'rg'on" },
    { id: "140", name: "Qiziriq" },
    { id: "141", name: "Qumqo'rg'on" },
    { id: "142", name: "Muzrabot" },
    { id: "143", name: "Oltinsoy" },
    { id: "144", name: "Sariosiyo" },
    { id: "145", name: "Sherobod" },
    { id: "146", name: "Sho'rchi" },
    { id: "147", name: "Termiz sh" },
    { id: "148", name: "Uzun" },
  ],
  "12": [ // Qoraqalpog'iston
