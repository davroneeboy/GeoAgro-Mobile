...
export const ROUTE_PERMISSIONS = {
  '/': [USER_ROLES.ADMIN, USER_ROLES.MODERATOR, USER_ROLES.HEAD_OF_REGION, USER_ROLES.OBSERVER],
  '/statistics/controllers': [USER_ROLES.ADMIN, USER_ROLES.MODERATOR, USER_ROLES.HEAD_OF_REGION, USER_ROLES.OBSERVER],
  '/statistics/regions': [USER_ROLES.ADMIN, USER_ROLES.MODERATOR, USER_ROLES.OBSERVER],
  '/statistics/fruits': [USER_ROLES.ADMIN, USER_ROLES.MODERATOR, USER_ROLES.OBSERVER],
  '/moderation': [USER_ROLES.ADMIN, USER_ROLES.MODERATOR],
  '/farmers': [USER_ROLES.ADMIN, USER_ROLES.MODERATOR, USER_ROLES.HEAD_OF_REGION, USER_ROLES.OBSERVER],
