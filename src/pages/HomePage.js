...
// ANIMATED COUNTER
// ═══════════════════════════════════════════════════════════════
const AnimatedNumber = ({ value, duration = 1000, format = "number", decimals = 0 }) => {
...
const GlassCard = ({ children, className = "", delay = 0, hover = true, onClick }) => {
  const [visible, setVisible] = useState(delay === 0); // Сразу показываем если нет задержки
    ...
    <GlassCard delay={delay} className="p-5">
      ...
      <div className="relative z-10">
        ...
        <p className={`text-2xl xl:text-3xl font-bold tracking-tight mb-1 ${isDark ? "text-white" : "text-slate-900"}`}>
          <AnimatedNumber value={value} format={format} duration={800 + delay} />
        </p>
...
const HomePage = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      // Загружаем данные параллельно, но обновляем состояние сразу после получения каждого
      ...
      // Обновляем данные сразу после получения
      setStats(statsData);
  ...
  // Если данные частично загружены, показываем их сразу
  ...
  const fullName = `${firstName} ${lastName}`.trim() || userInfo?.username || "Foydalanuvchi";
  const userRole = authState?.userRole || "user";
  const roleNames = {
    superuser: "Superadmin",
    headof_region: "Viloyat rahbari",
    observer: "Kuzatuvchi",
    user: "Foydalanuvchi"
  };
  const roleName = roleNames[userRole] || "Foydalanuvchi";
      ...
      <div className="relative z-10 p-4 md:p-6 lg:p-8">
        <div className="max-w-[1600px] mx-auto">
          ...
          {/* ═══════════════════════════════════════════════════════════
              USER PROFILE
          ═══════════════════════════════════════════════════════════ */}
          <GlassCard className="p-4 mb-6" delay={0} hover={false}>
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-full bg-gradient-to-br from-emerald-500/30 to-cyan-500/30 flex items-center justify-center ring-2 ring-emerald-500/20">
          ...
          <section className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 mb-8">
            ...
            {/* Plantation Types */}
            <GlassCard className="p-5" delay={140}>
          ...
          <section className="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-8">
            {/* Regions List */}
            <GlassCard className="p-5 xl:col-span-2" delay={180} hover={false}>
              <ChartWrapper 
                title="Viloyatlar" 
                ...
                action={
                  <div className="relative">
                    <select
                      ...
                      className={`
                        text-xs px-3 py-1.5 pr-8 rounded-lg 
                        border border-white/[0.1] outline-none
                        backdrop-blur-sm
                        transition-all duration-200
                        appearance-none cursor-pointer
                        ${isDark 
                          ? "bg-white/[0.08] text-slate-200 hover:bg-white/[0.12] hover:border-white/[0.15] focus:border-emerald-500/50" 
                          : "bg-slate-100 text-slate-700 hover:bg-slate-200 focus:border-emerald-500/50"
                        }
                      `}
                      style={{
                    ...
                    >
                      ...
                      <option value="pending" className="bg-slate-800 text-slate-200">Kutilayotganlar</option>
                      <option value="name" className="bg-slate-800 text-slate-200">Nomi bo'yicha</option>
                    </select>
                  </div>
                }
              >
            ...
            {/* Recent Activity */}
            <GlassCard className="p-5" delay={200} hover={false}>
              <ChartWrapper 
          ...
          <section className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4 mb-8">
            <GlassCard className="p-4 col-span-2" delay={220}>
              <div className="flex items-center gap-3">
            ...
            <GlassCard className="p-4 col-span-2" delay={240}>
              <div className="flex items-center gap-3">
            ...
            <GlassCard className="p-4 col-span-2" delay={260}>
              <div className="flex items-center gap-3">
            ...
            <GlassCard className="p-4 col-span-2" delay={280}>
              <div className="flex items-center gap-3">
          ...
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {/* Weekly Stats */}
            <GlassCard className="p-5" delay={320} hover={false}>
