              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                {plantations.map((plantation) => {
                  ...
                  return (
                    <div
                      key={plantation.id}
                      className="bg-gray-800 rounded-lg p-4 border border-gray-700 hover:border-yellow-600 hover:shadow-lg transition-all cursor-pointer"
                    ...
                    >
                      ...
                      <div className="flex justify-between items-start mb-3 pb-2 border-b border-gray-700">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1 flex-wrap">
                            ...
                            <span className="inline-block px-2 py-0.5 bg-yellow-600 text-white text-xs rounded font-semibold">
                              O'chirilgan
                            </span>
                        ...
                        <div className="mb-2 p-1.5 bg-gray-700/20 rounded border border-gray-600">
                          ...
                          <div className="flex flex-wrap gap-1">
                            {plantation.fruit_areas.slice(0, 4).map((fruit, idx) => {
                              const fruitName = (FRUIT_TYPES as Record<string, string>)[fruit.fruit] || fruit.fruit;
                              return (
                      ...
                      <div className="flex flex-wrap gap-2 mb-2 text-[10px]">
                        ...
                        {plantation.land_type && (
                          <span className="px-1.5 py-0.5 bg-gray-700/30 text-gray-300 rounded">
                            {landTypeMapping[plantation.land_type as keyof typeof landTypeMapping] || plantation.land_type}
                          </span>
                        )}
                        {totalInvestments > 0 && (
