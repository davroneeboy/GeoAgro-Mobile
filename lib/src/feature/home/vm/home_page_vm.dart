      ...
      if (data == null) {
        ...
        try {
          ...
          if (jsonData.containsKey("error")) {
            ...
            if (errorMessage.contains("уже отправлена") || errorMessage.contains("уже удалена")) {
              deletMessage = "Bu planatsiya allaqachon o'chirish uchun yuborilgan";
            } else {
          ...
          if (jsonData.containsKey("detail")) {
            ...
            if (detailMessage.contains("удален") || 
