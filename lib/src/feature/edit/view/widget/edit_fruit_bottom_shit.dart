          ...
          children: [
            ...
            GenericDropWidget(
              ...
              onChanged: (value) async {
                ...
                if (value != null) {
                  await Future.wait([
                    editVM.getFruitVerity(verity: value.name),
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        if (editVM.selectedFruit == null) {
                          ...
                          if (editVM.economicInefficientAreaController.text.isEmpty ||
                              double.tryParse(editVM.economicInefficientAreaController.text.replaceAll(',', '.')) == null ||
                              (double.tryParse(editVM.economicInefficientAreaController.text.replaceAll(',', '.')) ?? 0) < 0.1) {
                          ...
                          if (editVM.selectedDate2 == null) {
                            errorMessage = "Ekilgan yil tanlanmagan.";
                              ...
                              double.tryParse(editVM.cultivatedArea.text.replaceAll(',', '.')) == null ||
                              (double.tryParse(editVM.cultivatedArea.text.replaceAll(',', '.')) ?? 0) < 0.1) {
