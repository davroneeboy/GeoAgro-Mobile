...
class VersionCheckService {
  ...
  static Future<void> checkVersionAndShowUpdateDialog(BuildContext context, String? serverVersion) async {
    if (serverVersion == null || serverVersion.isEmpty) {
      debugPrint("🔍 Version check: server version is null/empty, skipping check");
    ...
    if (needsUpdate) {
      debugPrint("📱 Showing update dialog: app version is older than server version");
      if (context.mounted) {
        showDialog(
          context: context,
